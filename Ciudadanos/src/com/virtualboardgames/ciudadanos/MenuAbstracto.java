...
/*
public void crearTablaSocial(Table edadsexo, Table lealtadmiedo, Table nivel, Table media,
		Label espacioenblanco, int alturaespacioenblanco, String[] nombrecolumnasedadsexo,
		int rangoinferiorcolumnasedadsexo, int rangosuperiorcolumnasedadsexo, 
		String[] nombrecolumnaslealtad, int rangoinferiorcolumnaslealtad,
		int rangosuperiorcolumnaslealtad, String[] nombrecolumnasnivel, 
		int rangoinferiorcolumnasnivel, int rangosuperiorcolumnasnivel, 
		String[] nombrecolumnasmedia, int rangoinferiorcolumnasmedia,
		int rangosuperiorcolumnasmedia, int[] intsdelatablames,
		int[]intsdelatablaano, int[] intsdelatablatotal, Array<Label> arraydealmacenamientodeints,
		int anchocolumnas, int anchoprimeracolumna, LabelStyle estilolabel, int espacioentrefilas,
		String[] nombredelasfilas, int numerodefilas, int numerodecolumnas)
		{
