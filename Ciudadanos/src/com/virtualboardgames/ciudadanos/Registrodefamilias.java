...
public void crearfamiliadealdeanos(int lealtadbase, int miedobase, int nivelbase){
	...
	Registrodeindividuos.registrodeindividuos.crearnuevoindividuo(familia,true, 16, lealtadbase, miedobase, "aldeanos", 0);
	Registrodeindividuos.registrodeindividuos.crearnuevoindividuo(familia,false, 16, lealtadbase, miedobase, "aldeanos", 0);
	Registrodeindividuos.registrodeindividuos.crearnuevoindividuo(familia,true, 45, lealtadbase, miedobase, "aldeanos", 0);
	Registrodeindividuos.registrodeindividuos.crearnuevoindividuo(familia,false, 45, lealtadbase, miedobase, "aldeanos", 0);
	Registrodeindividuos.registrodeindividuos.crearnuevoindividuo(familia,true, 0, lealtadbase, miedobase, "aldeanos", 0);
	Registrodeindividuos.registrodeindividuos.crearnuevoindividuo(familia,false, 0, lealtadbase, miedobase, "aldeanos", 0);
